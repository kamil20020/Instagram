...
public interface PostMapper {
    ...
    PostEntityForLoggedUser postEntityToPostEntityForLoggedUser(PostEntity postEntity);
    ...
    @Mapping(source = "content", target = "content", qualifiedByName = "byteArrayToBase64")
    @Mapping(source = "creationDatetime", target = "creationDatetime", qualifiedByName = "localDatetimeToOffsetDatetime")
    PostDetails postEntityForLoggedUserToPostDetails(PostEntityForLoggedUser postEntityForLoggedUser);
